...
public class BookLater extends Fragment implements View.OnClickListener, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, com.google.android.gms.location.LocationListener {
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        */
        ...
        if (pickup_point == null) {
            ...
            if ((southwest != null)) {
                Helper.SystemPrintLn("******haha**my curn loc is : " + southwest.longitude + " " + southwest.latitude);
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        Helper.logD("BOOK_LATER_FRAGMENT", "onActivityCreated");
    ...
    public void onClick(View v) {
        ...
        //Helper.putPreference(getActivity(), "selected_booking_datetime", booking_datetime);
