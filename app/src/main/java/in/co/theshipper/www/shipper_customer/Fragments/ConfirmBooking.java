...
public class ConfirmBooking extends Fragment implements View.OnClickListener{
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        if(this.getArguments() != null) {
            ...
            pickup_address = Helper.getValueFromBundle(bundle,"selected_pickup_address");
            dropoff_address = Helper.getValueFromBundle(bundle, "selected_dropoff_address");
            booking_datetime = Helper.getValueFromBundle(bundle, "selected_booking_datetime");
            material_weight = Helper.getValueFromBundle(bundle, "selected_material_weight");
            material_image = Helper.getValueFromBundle(bundle, "selected_material_image");
            this.getArguments().clear();

        }

        selected_vehicle =  Helper.getPreference(getActivity(), "selected_vehicle");
        String URL = makeURL(pickup_address,dropoff_address);
        HashMap<String,String> hashMap = new HashMap<String,String>();
        sendVolleyRequest(URL,Helper.checkParams(hashMap),"googleAPI");
    ...
    public void onClick(View v) {
        ...
        sendVolleyRequest(confirm_booking_url,Helper.checkParams(hashMap),"confirm_booking");
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URL, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                if(method.equals("googleAPI")) {
                    ...
                    Helper.logD("trimmed_response", trimmed_response);
    ...
    public void DistanceRecieveSuccess(String response)  {
        ...
        try {
            ...
            int city_id = Integer.parseInt(Helper.getPreference(getActivity(), Constants.Keys.CITY_ID));
            ...
            booking_datetime_view.setText(Helper.getDateName(String.valueOf(booking_datetime)));
