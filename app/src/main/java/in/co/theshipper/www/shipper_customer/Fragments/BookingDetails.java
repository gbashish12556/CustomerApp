...
public class BookingDetails extends Fragment implements View.OnClickListener{
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        if(getActivity() != null) {
            ...
            Helper.logD("booking_status_url", booking_status_url);
                    ...
                    if (jsonObject.has("likes")) {
                        ...
                        while (count < jsonArray.length()) {
                            ...
                            if (received_is_cancelled.equals("0") && received_is_active.equals("1") && (!booked_vehicle_id.equals("0"))) {
                                ...
                                Helper.putPreference(getActivity(), "driver_token", received_driver_token);
                                ...
                                location_datetime.setText("Last Seen: " + Helper.getDateName(received_driver_location_datetime));
                ...
                if(errFlag.equals("0"))
                {
                    ...
                    if(jsonObject.has("likes"))
                    {
                        ...
                        while (count < jsonArray.length())
                        {
                            ...
                            map.setVisibility(View.VISIBLE);
                            map_view.setVisibility(View.GONE);
                            Helper.logD("LocationSuccessCallingMap","LocationSuccessCallingMap");
                            setUpMapIfNeeded();
                            count++;
    ...
    private void setUpMapIfNeeded() {
        ...
        if(getActivity() != null) {
            ...
            if (mMap == null) {
                ...
                Helper.logD("map_not_null", String.valueOf(mMap));
